...
$(function() {
    ...
    jQuery(document).ready(function($) {
        ...
        $("#sweetNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex1").bootstrapSlider("disable");
            $("#ex1").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
        ...
        $("#saltyNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex2").bootstrapSlider("disable");
            $("#ex2").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
        ...
        $("#savoryNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex3").bootstrapSlider("disable");
            $("#ex3").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
  					$("#ex3").bootstrapSlider("enable");
  				}
  	     });
        ...
        $("#bitterNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex4").bootstrapSlider("disable");
            $("#ex4").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
  					$("#ex4").bootstrapSlider("enable");
  				}
  	     });
        ...
        $("#sourNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex5").bootstrapSlider("disable");
            $("#ex5").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
  					$("#ex5").bootstrapSlider("enable");
  				}
  	     });
        ...
        $("#spicyNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex6").bootstrapSlider("disable");
            $("#ex6").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
  					$("#ex6").bootstrapSlider("enable");
  				}
  	     });
        ...
        $("#presentationNotApp").click(function(){
  	      if($(this).is(':checked')){
  					$("#ex7").bootstrapSlider("disable");
            $("#ex7").bootstrapSlider('setValue', [0,0]);
  	     	}
  	    	else {
