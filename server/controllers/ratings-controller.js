...
module.exports.newRatings = function (req, res) {
    // var entryArray = req.query.data;
    // req.db.collection('venueMenus').find({"menus.entries.items.entries.items.entryId": req.query.data[0]})
    //     .toArray(function (err, menu) {
    //         var items = findItems(menu, entryArray)
